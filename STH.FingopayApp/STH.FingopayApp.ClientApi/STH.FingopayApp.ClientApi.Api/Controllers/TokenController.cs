...
using STH.FingopayApp.ClientApi.Api.Models;
...
namespace STH.FingopayApp.ClientApi.Api.Controllers
{
    ...
    public class TokenController : Controller
    {
        ...
        private string BuildToken(UserModel user)
        {
            ...
            claims.Add(new Claim(JwtRegisteredClaimNames.Sub, user.FirstName));
            claims.Add(new Claim(JwtRegisteredClaimNames.Sub, user.LastName));
        ...
        private UserModel Authenticate(LoginModel login)
        {
            ...
            {
                user = new UserModel { FirstName = userView.FirstName, LastName = userView.LastName, Email = userView.Email, Roles = new string[] { } };
