...
namespace STH.FingopayApp.ClientApi.Entity.UnitofWork
{
    ...
    {
        public ClientApiContext Context { get; }

        private Dictionary<Type, object> _repositoriesAsync;
        private Dictionary<Type, object> _repositories;
        private bool _disposed;

        public UnitOfWork(ClientApiContext context)
        {
            Context = context;
            _disposed = false;
        }
